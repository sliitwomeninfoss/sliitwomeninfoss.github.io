        ...
        venobox: function (options) {
            ...
            return this.each(function () {
                ...
                obj.on('click', function (e) {
                    ...
                    overlayColor =
                        obj.data('overlay') || obj.data('overlaycolor')
                ...
                function navigateGall(destination) {
                    ...
                    overlayColor =
                        destination.data('overlay') ||
                        destination.data('overlaycolor')
                ...
                function loadInline() {
                    content.html(
                        '<div class="vbox-inline">' + $(dest).html() + '</div>'
                    )
                    updateoverlay()
                }
